  ...
  return (
    <>
      ...
      <tr style={{ "backgroundColor": "whitesmoke" }}>
        ...
        <td><p className={styles.cardcontent} style={{ "paddingLeft": "16rem" }}>{credentials.quantity}</p></td>
        <td><p className={styles.cardcontent} style={{ "paddingLeft": "16rem", "paddingRight": "10rem" }}><button onClick={handleGrade} className='btn btn-dark'>Return to PAC</button></p></td>
      </tr>
    </>
  )
}
