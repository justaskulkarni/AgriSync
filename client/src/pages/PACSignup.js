                                            ...
                                            <div className="card-body p-md-5 mx-md-4">
                                                ...
                                                <form>
                                                    ...
                                                    <div className="form-outline mb-4">
                                                        ...
                                                        <input type="text" value={credentials.district} name="district" onChange={onChange} placeholder="District" className="form-control" />
                                                        <label
                                                    ...
                                                    <div className="form-outline mb-4">
                                                        ...
                                                        <input type="text" value={credentials.state} name="state" onChange={onChange} placeholder="State" className="form-control" />
                                                        <label
                                                            className="form-label"
                                                            htmlFor="form2Example11"
                                                        >
